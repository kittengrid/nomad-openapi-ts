...
/* tslint:disable */
/* eslint-disable */
import type { ScalingPolicy } from '../models/ScalingPolicy';
import type { ScalingPolicyListStub } from '../models/ScalingPolicyListStub';
...
export class ScalingService {
     ...
     * @returns ScalingPolicyListStub
     * @throws ApiError
     */
    public getScalingPolicies(
        region?: string,
        namespace?: string,
        index?: number,
        wait?: string,
        ...
        perPage?: number,
        nextToken?: string,
    ): CancelablePromise<Array<ScalingPolicyListStub>> {
    ...
    public getScalingPolicy(
        ...
        perPage?: number,
        nextToken?: string,
    ): CancelablePromise<ScalingPolicy> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/scaling/policy/{policyID}',
            path: {
                'policyID': policyId,
            },
            headers: {
