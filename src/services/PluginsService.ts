...
/* tslint:disable */
/* eslint-disable */
import type { CSIPlugin } from '../models/CSIPlugin';
import type { CSIPluginListStub } from '../models/CSIPluginListStub';
...
export class PluginsService {
    ...
    public getPluginCsi(
        ...
        perPage?: number,
        nextToken?: string,
    ): CancelablePromise<Array<CSIPlugin>> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/plugin/csi/{pluginID}',
            path: {
                'pluginID': pluginId,
            },
            headers: {
    ...
    public getPlugins(
        ...
        perPage?: number,
        nextToken?: string,
    ): CancelablePromise<Array<CSIPluginListStub>> {
        return this.httpRequest.request({
            method: 'GET',
            url: '/plugins',
            headers: {
